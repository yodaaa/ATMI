...
<body bgcolor="#ffffff" onLoad="document.chat_form.mesg.focus()">
<h1>phpチャット</h1>
...
/* COOKIE 処理 */
if($_POST['name'] != $_COOKIE['chat_name']){ 
$_COOKIE['chat_name'] = $_POST['name']; // COOKIE 
setcookie("chat_name", $_POST['name']); // COOKIE 
}
/* フォーム表示 */
...
名前：<input type="text" size=10 name="name" value="<?php print $_COOKIE['chat_name']; ?>">
メッセージ：<input type="text" size=30 name="mesg" pattern="/<.+?>/">
